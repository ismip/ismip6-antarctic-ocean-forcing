...
for date in dates:
    for field in ['so', 'thetao']:
        inFileName = '{}/{}_Omon_IPSL-CM5A-MR_rcp85_r1i1p1_{}.nc'.format(
            args.out_dir, field, date)

        outFileName = '{}/{}_annual_IPSL-CM5A-MR_rcp85_r1i1p1_{}.nc'.format(
            args.out_dir, field, date)
...
for field in ['so', 'thetao']:
    outFileName = \
        '{}/{}_annual_IPSL-CM5A-MR_rcp85_r1i1p1_195001-210012.nc'.format(
            args.out_dir, field)
