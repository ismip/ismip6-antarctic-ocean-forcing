...
#SBATCH --job-name=ismip6_@years
#SBATCH --output=ismip6_@years.o%j
#SBATCH --error=ismip6_@years.e%j
#SBATCH -L SCRATCH
#SBATCH -C haswell
...
srun -N 1 -n 1 -c 1 python -m ismip6_ocean_forcing ccsm4/@years/config.ccsm4
